...
- Only delegate when a sub-agent's skills clearly match the task. For general requests, handle them yourself.`,
  tools: { readDocument, updateStoryboard, listAvatars, listSceneLayouts, proposeMemory, showOptions, showSuggestions, listAgentConfigs: listAgentConfigsTool, delegateToAgent: delegateToAgentTool },
